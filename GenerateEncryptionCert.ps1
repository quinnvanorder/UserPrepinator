...
#Everything after this was not included in the stock script to create certs. Additions are pulled from https://docs.microsoft.com/en-us/powershell/dsc/securemof
New-SelfsignedCertificateEx `
    -Subject "CN=$Name" `
    -EKU 'Document Encryption' `
    -KeyUsage 'KeyEncipherment, DataEncipherment' `
    -SAN $Name `
    -FriendlyName 'SWAT Systems Secure Creds' `
    -Exportable `
...
$Cert = Get-ChildItem -Path cert:\LocalMachine\My | Where-Object {
        ($_.FriendlyName -eq 'SWAT Systems Secure Creds') -and ($_.Subject -eq "CN=$Name")
    } | Select-Object -First 1
# export the public key certificate
$cert | Export-Certificate -FilePath "C:\temp\$Name.cer" -Force
